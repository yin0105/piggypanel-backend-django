...
class contacts(models.Model):
    ...
    def save(self, *args, **kwargs): 
        allocated = self.data[settings.ZCRM_CONTACTS_FIELD_MAP_ALLOCATED_TO_API_NAME]
...
@reversion.register()
class contacts_fields(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
...
@reversion.register()
class contacts_addedit_layout(models.Model):
    id=models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    ...
    layout_field = models.ForeignKey(contacts_fields,on_delete=models.SET_NULL, blank=True, null=True)
...
@reversion.register()
class contacts_browse_layout(models.Model):
    id=models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    layout_col = models.IntegerField(verbose_name="Column Number")
    layout_col_width = models.IntegerField(verbose_name="Column Width")
    layout_field = models.ForeignKey(contacts_fields,on_delete=models.CASCADE)
